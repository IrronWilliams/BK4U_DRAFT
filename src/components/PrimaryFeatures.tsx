...
import screenshotCashBills from '@/images/screenshots/cashbills.jpg'
import screenshotTaxForm from '@/images/screenshots/taxformcalc.jpg'
import screenshotRulerChart from '@/images/screenshots/rulerchart.jpg'
import screenshotConferenceRoom from '@/images/screenshots/conferenceroom.jpg'
import screenshotCalcPenBinder from '@/images/screenshots/calcpenbinder.jpg'
...
const features = [
  {
    title: 'Payroll',
    description:
      "Handle aspects of your employee payments like payroll, benefits, and taxes.",
    image: screenshotCashBills,
  },
  {
    title: 'Bookkeeping',
    description:
    ...
    >
      ...
      <Container className="relative">
        <div className="max-w-2xl md:mx-auto md:text-center xl:max-w-none">
          ...
          Let's work together to simplify your bookkeeping and move your business forward.
          </p>
        </div>
        <TabGroup
